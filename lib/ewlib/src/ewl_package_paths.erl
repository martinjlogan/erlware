...
%%% @doc Codification of key paths within an Erlware pre installed package. 
%%% @copyright (C) 2007, Martin Logan, Erlware
%%% @end
%%% Created : 14 Dec 2007 by Martin Logan <martinjlogan@erlware.org>
%%%-------------------------------------------------------------------
-module(ewl_package_paths).
