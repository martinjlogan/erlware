...
delete_callback_module(CallBackModule) ->
    store_callback_modules(lists:delete(CallBackModule, lookup_callback_modules())).
...
delete_target_type(TargetType) ->
    store_target_types(lists:delete(TargetType, lookup_target_types())).
...
delete_local_resource(LocalResource) ->
    store_local_resources(lists:delete(LocalResource, lookup_local_resources())).
...
delete_resource({Type, Resource}) ->
    store_resource(lists:delete(Resource, lookup_resources(Type))).
